...
this_program_name="testProject-test.sh"
...
${this_program_name}: run integration/regression tests for testProject 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/testProject -d data/tests
